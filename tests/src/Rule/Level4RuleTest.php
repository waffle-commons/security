...
use Waffle\Commons\Security\Rule\Level4Rule;
use WaffleTests\Commons\Security\AbstractTestCase as TestCase;
use WaffleTests\Commons\Security\Helper\Rule4InvalidObject;
use WaffleTests\Commons\Security\Helper\Rule4TypedChildUntypedParent;
use WaffleTests\Commons\Security\Helper\Rule4ValidObject;
